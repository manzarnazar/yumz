...
export default function GuestCheckoutProductItem({ data, disabled, formik }: Props) {
  ...
  const { totalPrice } = calculateCartProductTotal(data);
...
const [cartId, setCartId] = useState<string | null>(null);
  ...
  function storeProductToCart(product: CartStockWithProducts) {
    const body: InsertProductBody = {
      ...
      user_cart_uuid: uui ?? "", // Include the uuid in the request body
    };
